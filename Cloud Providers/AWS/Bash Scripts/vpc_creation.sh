#An important detail to note here is that, depending on the VPC CIDR range your workload requires, this can be modified at line #3, 7 & 8 which denote the CIDR prefix of the VPC, public, and private subnets respectively.
