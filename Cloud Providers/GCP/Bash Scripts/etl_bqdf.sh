...
#This script sets up an ETL workflow using bigquery and dataflow
...
then
  ...
  then
    ...
    then
      ...
      then
        printf "\n\e[1;96m%s\n\n\e[m" 'Data Ingestion Pipeline Created'
        sleep 2.5
        ...
        then
          printf "\n\e[1;96m%s\n\n\e[m" 'Data Transformation Pipeline Created'
          sleep 2.5
          ...
          then
            printf "\n\e[1;96m%s\n\n\e[m" 'Data Enrichment Pipeline Created'
            sleep 2.5
            ...
            then
              printf "\n\e[1;96m%s\n\n\e[m" 'Data lake to Mart Pipeline Created'
